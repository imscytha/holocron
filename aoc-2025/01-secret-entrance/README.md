...
The good news is that they've discovered [project management][0]! This has
...
has a *distance* value which indicates how many clicks the dial should be rotated
in that direction.
...
[0]: https://en.wikipedia.org/wiki/Project_management
